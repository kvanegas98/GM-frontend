      ...
      <v-toolbar flat color="white">
        <v-btn @click="crearPdfVentas">
         ...
         <export-excel
          ...
          :data = "ventas"
          :fields = "json_fields"
           worksheet = "Ventas Contado"
          :title ="fecha2"
         type    = "xls"
           name    = "Ventas Credito.xls"
           >
           <v-btn color="green">
...
export default {
  ...
  methods: {
     prueba(){
       this.fecha2 = this.fechaInicio;
       this.fecha2 ="Reporte de ventas de crédito del "+this.fechaInicio+" Al"
       +" "+this.fechaFin;
      //alert(this.fecha2);
    },
    redirigir() {
    ...
    crearPdfVentas() {
      ...
      doc.save("Listado de Ventas Credito.pdf");
    },
    crearPDF() {
    ...
    listar() {
      ...
      if (!me.fechaInicio || !me.fechaFin) {
       ...
       // this.fecha2 = this.fechaInicio;
       me.fecha2 ="Reporte de ventas de crédito del "+me.fechaInicio+"  Al  "
       +"   "+me.fechaFin;
