    ...
    <v-flex>
      ...
      <v-container grid-list-sm class="pa-4 white" v-if="verNuevo">
        <v-layout row wrap>
          ...
          <v-flex xs12 sm4 md4 lg4 xl4>
            <v-text-field required type="number" v-model="impuesto" label="Impuesto">
            </v-text-field>
          </v-flex>
          <v-flex xs12 sm8 md8 lg8 xl8>
            <v-text-field
          ...
          <v-flex xs12 sm12 md12 lg12 xl12>
              ...
              <template slot="items" slot-scope="props">
                ...
                <td>
                  <v-text-field
                    type="number"
                    disabled
                    v-model="props.item.precio_venta"
                    class="no-spinners"
                    @keydown.up.prevent="handleKeyDown"
                    @keydown.down.prevent="handleKeyDown"
                    @mousewheel="handleKeyDown"
            ...
            <v-flex class="text-xs-right">
              ...
              {{ (totalParcial = calcularTotal.toFixed(2)) | toCurrency }}
            </v-flex>
            <v-flex class="text-xs-right">
              <strong>Total Impuesto: </strong>
              {{ (totalImpuesto = impuesto) | toCurrency }}
            </v-flex>
            <v-flex class="text-xs-right">
...
export default {
  data() {
    return {
      ...
      cabeceraDetalles: [
        ...
        { text: "Precio Compra", value: "precio", sortable: false },
  ...
  methods: {
    ...
    guardar() {
     ...
     // alert("Expira: "+me.$store.state.usuario.exp);
      axios
        .post(
          "api/Ingresos/Crear",
          {
    ...
    validar() {
      this.valida = 0;
      this.validaMensaje = [];
      let _impuesto = parseFloat(this.impuesto);
     // alert("-: "+_impuesto);
     /*   if (parseFloat(this.impuesto)<0) {
