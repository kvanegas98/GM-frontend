...
export default {
  ...
  methods: {
    ...
    loadProductosMasVendidos() {
      ...
      me.totalMeses2 = me.totalMeses.toLocaleString("en-US",{style:"currency", currency:"USD"});
      //console.log("Repicado ",me.totalmeses2);
          ...
          datasets: [
            {
             ...
             // data: me.totalMeses.toLocaleString("en-US",{style:"currency", currency:"USD"}),
              data: me.totalMeses,
   ...
   animation: false,
    //legend: {display: false},
     //maintainAspectRatio: false,
      ...
      animation: false,
      /*   scaleLabel:
        function(labels){return  ' $' + me.totalMeses.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");},
 */
          scales: {
            yAxes: [
              {
