  ...
  methods: {
    ...
    listar() {
      ...
      if (!me.fechaInicio || !me.fechaFin) {
        url = "api/Ventas/ConsultaVentasClientes";
         me.fecha2 ="Mejores 30 clientes totales";
      } else {
         me.fecha2 ="Mejores 30 clientes del "+me.fechaInicio+"  Al  "
       +"   "+me.fechaFin;
        url = "api/Ventas/ConsultaFechasClientes/" + me.fechaInicio + "/" + me.fechaFin;
      }
      axios
