    ...
    <v-flex>
      <v-toolbar flat color="white">
       <!--  <v-btn @click="crearPdfVentas">
        ...
        <v-toolbar-title>Mejores Clientes</v-toolbar-title>
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Total de las ventas", value: "Total", sortable: false },
  ...
  methods: {
    ...
    listar() {
      ...
      if (!me.fechaInicio || !me.fechaFin) {
         me.fecha2 ="Mejores 30 clientes de contado";
        url = "api/Ventas/ConsultaVentasClientesContado";
      } else {
         me.fecha2 ="Mejores 30 clientes de contado del "+me.fechaInicio+"  Al  "
       +"   "+me.fechaFin;
        url = "api/Ventas/ConsultaFechasClientesContado/" + me.fechaInicio + "/" + me.fechaFin;
      }
      axios
