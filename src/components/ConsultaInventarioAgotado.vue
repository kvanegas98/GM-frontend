    ...
    <v-flex>
      <v-toolbar flat color="white">
        ...
        <export-excel
          :data="articulos"
          :fields="json_fields"
          worksheet="Inventario Agotado"
          title="Inventario Agotado"
          type="xls"
          name="Inventario Agotado.xls"
        >
          <v-btn color="green">
            <v-icon color="white">print</v-icon>
          </v-btn>
...
export default {
  ...
  methods: {
    ...
    crearPdf() {
      ...
      doc.autoTable(columns, rows, {
        ...
        addPageContent: function (data) {
          doc.text("Listado de Artículos Agotados", 250, 30);
          /* doc.text(
      ...
      doc.save("Inventario agotado.pdf");
    },
    /* crearExcel() {
      var columns = [
        { title: "Nombre", dataKey: "nombre" },
    ...
    listar() {
      ...
      let configuracion = { headers: header };
      axios
        .get("api/Articulos/SelectAgotado/"+me.sucursal, configuracion)
        .then(function (response) {
