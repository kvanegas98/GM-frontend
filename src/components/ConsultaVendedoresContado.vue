    ...
    <v-flex>
      <v-toolbar flat color="white">
        <!-- <v-btn @click="crearPdfVentas">
         ...
         <export-excel
          ...
          :data = "ventas"
         :fields = "json_fields"
           worksheet = "Vendedores"
          :title ="fecha2"
         type    = "xls"
           name    = "Ventas vendedores.xls"
           >
           <v-btn color="green">
             <v-icon color="white">print</v-icon>
           </v-btn>
        </export-excel>
        <v-toolbar-title>Mejores vendedores</v-toolbar-title>
      ...
      >
        <template slot="items" slot-scope="props">
          ...
          <td>{{ props.item.ventastotales | currency }}</td>
        </template>
...
export default {
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Vendedor", value: "nombre", sortable: false },
        { text: "Total de venta", value: "Total", sortable: false },
  ...
  methods: {
    ...
    crearPdfVentas() {
      ...
      doc.save("Listado de Ventas Contado.pdf");
    },
    crearPDF() {
    ...
    listar() {
      ...
      if (!me.fechaInicio || !me.fechaFin) {
        url = "api/Ventas/ConsultaVentasVendedoresContado";
         me.fecha2 ="Reporte de ventas totales de Contado";
      } else {
         me.fecha2 ="Reporte de ventas de contado del "+me.fechaInicio+"  Al  "
       +"   "+me.fechaFin;
        url = "api/Ventas/ConsultaFechasVendedoresContado/" + me.fechaInicio + "/" + me.fechaFin;
      }
      axios
