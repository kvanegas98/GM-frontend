  ...
  methods: {
    ...
    listar() {
      ...
      if (!me.fechaInicio || !me.fechaFin) {
        url = "api/Ventas/ConsultaVentasClientesCredito";
         me.fecha2 ="Mejores 30 clientes de crédito";
      } else {
         me.fecha2 ="Mejores 30 clientes crédito del "+me.fechaInicio+"  Al  "
       +"   "+me.fechaFin;
        url = "api/Ventas/ConsultaFechasClientesCredito/" + me.fechaInicio + "/" + me.fechaFin;
      }
      axios
